...
public class Constants {
    public static final String BASE_IMAGE = "jafarisharib/pi-harness";
    public static final  List<String> HARNESS_EXEC =  List.of("pi", "-a", "-p", "--continue");
    public static final String WORKING_DIR = "/app";
    public static final String TASK_PROMPT = """
